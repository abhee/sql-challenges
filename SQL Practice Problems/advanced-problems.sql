...
Select A.EmployeeID,
       TotalOrders,
       COALESCE(TotalLateOrders, NULL, 0),
...
Select O1.CustomerId,
       O1.OrderId                              As InitialOrder,
       O1.OrderDate::date                      As InitialOrderDate,
       O2.OrderId                              AS NextOrder,
       O2.OrderDate::date                      As NextOrderDate,
       Date(O2.OrderDate) - Date(O1.OrderDate) As DaysInBetween
From Orders O1
         JOIN Orders O2
